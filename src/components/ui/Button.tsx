...
const sizes: Record<Size, string> = {
  xs: "px-2.5 py-1.5 text-xs gap-1 rounded-lg h-8 min-w-8",
  sm: "px-3.5 py-2 text-xs gap-1.5 rounded-lg h-9 min-h-[44px] md:h-8 md:min-h-auto",
  md: "px-4 py-2.5 text-sm gap-2 rounded-xl h-10 min-h-[44px] md:h-9 md:min-h-auto",
  lg: "px-5 py-3 text-sm gap-2 rounded-xl h-11 min-h-[48px] md:h-10 md:min-h-auto",
};
