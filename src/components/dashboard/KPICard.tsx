  ...
  return (
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      <div
        onClick={onClick}
        className={cn(
          "bg-white rounded-2xl border p-5 relative overflow-hidden transition-all duration-200",
          "shadow-[0_1px_4px_rgba(15,23,42,0.06),0_0_0_1px_rgba(15,23,42,0.02)]",
          onClick && "cursor-pointer hover:shadow-[0_6px_20px_rgba(15,23,42,0.1)] hover:-translate-y-0.5",
      ...
      >
        ...
        <div className="flex items-start justify-between gap-3 mb-3">
          <p className="text-xs font-bold text-slate-500 uppercase tracking-widest leading-none">{title}</p>
          {icon && (
